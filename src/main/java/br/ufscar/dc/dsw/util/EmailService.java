...
import br.ufscar.dc.dsw.controller.AgendamentoController;
...
public class EmailService {
	...
	public void send(InternetAddress from, InternetAddress to, String subject, String body, File file) {
		...
		try {
			...
			InputStream is = AgendamentoController.class.getClassLoader().getResourceAsStream("config.properties");
